...
describe('CustomerController unit test', () => {
  ...
  beforeEach(async () => {
    const mockCustomerService = {
      ...
      generateCongratulationMessageV5: jest
        .fn()
  ...
  it('should generate congratulation message', (done) => {
    controller.generateCongratulationMessageV5().subscribe({
      next: (message) => {
    ...
    expect(customerService.generateCongratulationMessageV5).toHaveBeenCalled();
  });
});
